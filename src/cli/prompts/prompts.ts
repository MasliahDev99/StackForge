 ...
 */
async function promptGeneralProjectConfig(): Promise<Pick<UserAnswers, 'projectName' | 'packageName' | 'bundler' | 'language' | 'packageManager'> | null> {
 ...
 */
async function promptTailwindConfig(): Promise<Pick<UserAnswers, 'useTailwind' | 'tailwindVersion'> | { useTailwind: boolean } | null> {
 ...
 */
async function promptDepsConfig(): Promise<Pick<UserAnswers, 'installDeps' | 'depsList'> | { installDeps: boolean } | null> {
 ...
 */
async function promptFolderStructureConfig(): Promise<Pick<UserAnswers, 'createFolders' | 'folderStructure'> | { createFolders: boolean } | null> {
